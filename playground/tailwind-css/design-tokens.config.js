 ...
 * Generated on Thu, 03 Aug 2023 08:55:00 GMT
 *
...
module.exports = {
  theme: {
    ...
    size: {
      icon: {
        'extra-small': 'var(--telekom-size-icon-extra-small)',
        small: 'var(--telekom-size-icon-small)',
        medium: 'var(--telekom-size-icon-medium)',
        large: 'var(--telekom-size-icon-large)',
        'extra-large': 'var(--telekom-size-icon-extra-large)',
      },
      'form-element-height': {
        small: 'var(--telekom-size-form-element-height-small)',
        DEFAULT: 'var(--telekom-size-form-element-height-standard)',
      },
      generic: {
        'size-01': 'var(--telekom-size-generic-size-01)',
        'size-02': 'var(--telekom-size-generic-size-02)',
        'size-03': 'var(--telekom-size-generic-size-03)',
        'size-04': 'var(--telekom-size-generic-size-04)',
        'size-05': 'var(--telekom-size-generic-size-05)',
        'size-06': 'var(--telekom-size-generic-size-06)',
        'size-07': 'var(--telekom-size-generic-size-07)',
        'size-08': 'var(--telekom-size-generic-size-08)',
        'size-09': 'var(--telekom-size-generic-size-09)',
        'size-10': 'var(--telekom-size-generic-size-10)',
        'size-11': 'var(--telekom-size-generic-size-11)',
        'size-12': 'var(--telekom-size-generic-size-12)',
        'size-13': 'var(--telekom-size-generic-size-13)',
        'size-14': 'var(--telekom-size-generic-size-14)',
        'size-15': 'var(--telekom-size-generic-size-15)',
        'size-16': 'var(--telekom-size-generic-size-16)',
        'size-17': 'var(--telekom-size-generic-size-17)',
        'size-18': 'var(--telekom-size-generic-size-18)',
        'size-19': 'var(--telekom-size-generic-size-19)',
        'size-20': 'var(--telekom-size-generic-size-20)',
        'size-21': 'var(--telekom-size-generic-size-21)',
        'size-22': 'var(--telekom-size-generic-size-22)',
        'size-23': 'var(--telekom-size-generic-size-23)',
        'size-24': 'var(--telekom-size-generic-size-24)',
        'size-25': 'var(--telekom-size-generic-size-25)',
      },
    },
    borderWidth: {
    ...
    spacing: {
      ...
      composition: {
        'space-00': 'var(--telekom-spacing-composition-space-00)',
        'space-01': 'var(--telekom-spacing-composition-space-01)',
        'space-02': 'var(--telekom-spacing-composition-space-02)',
        'space-03': 'var(--telekom-spacing-composition-space-03)',
        'space-04': 'var(--telekom-spacing-composition-space-04)',
        'space-05': 'var(--telekom-spacing-composition-space-05)',
        'space-06': 'var(--telekom-spacing-composition-space-06)',
        'space-07': 'var(--telekom-spacing-composition-space-07)',
        'space-08': 'var(--telekom-spacing-composition-space-08)',
        'space-09': 'var(--telekom-spacing-composition-space-09)',
        'space-10': 'var(--telekom-spacing-composition-space-10)',
        'space-11': 'var(--telekom-spacing-composition-space-11)',
        'space-12': 'var(--telekom-spacing-composition-space-12)',
        'space-13': 'var(--telekom-spacing-composition-space-13)',
        'space-14': 'var(--telekom-spacing-composition-space-14)',
        'space-15': 'var(--telekom-spacing-composition-space-15)',
        'space-16': 'var(--telekom-spacing-composition-space-16)',
        'space-17': 'var(--telekom-spacing-composition-space-17)',
        'space-18': 'var(--telekom-spacing-composition-space-18)',
        'space-19': 'var(--telekom-spacing-composition-space-19)',
        'space-20': 'var(--telekom-spacing-composition-space-20)',
        'space-21': 'var(--telekom-spacing-composition-space-21)',
      },
      baseline: {
        'space-00': 'var(--telekom-spacing-baseline-space-00)',
        'space-01': 'var(--telekom-spacing-baseline-space-01)',
        'space-02': 'var(--telekom-spacing-baseline-space-02)',
        'space-03': 'var(--telekom-spacing-baseline-space-03)',
        'space-04': 'var(--telekom-spacing-baseline-space-04)',
        'space-05': 'var(--telekom-spacing-baseline-space-05)',
        'space-06': 'var(--telekom-spacing-baseline-space-06)',
        'space-07': 'var(--telekom-spacing-baseline-space-07)',
        'space-08': 'var(--telekom-spacing-baseline-space-08)',
        'space-09': 'var(--telekom-spacing-baseline-space-09)',
        'space-10': 'var(--telekom-spacing-baseline-space-10)',
        'space-11': 'var(--telekom-spacing-baseline-space-11)',
        'space-12': 'var(--telekom-spacing-baseline-space-12)',
        'space-13': 'var(--telekom-spacing-baseline-space-13)',
        'space-14': 'var(--telekom-spacing-baseline-space-14)',
        'space-15': 'var(--telekom-spacing-baseline-space-15)',
      },
    },
    textStyle: {
      fluid: {
        badge: 'var(--telekom-text-style-fluid-badge)',
        small: 'var(--telekom-text-style-fluid-small)',
        'small-bold': 'var(--telekom-text-style-fluid-small-bold)',
        caption: 'var(--telekom-text-style-fluid-caption)',
        'caption-bold': 'var(--telekom-text-style-fluid-caption-bold)',
        body: 'var(--telekom-text-style-fluid-body)',
        'body-bold': 'var(--telekom-text-style-fluid-body-bold)',
        ui: 'var(--telekom-text-style-fluid-ui)',
        'ui-bold': 'var(--telekom-text-style-fluid-ui-bold)',
        'lead-text': 'var(--telekom-text-style-fluid-lead-text)',
        'heading-6': 'var(--telekom-text-style-fluid-heading-6)',
        'heading-5': 'var(--telekom-text-style-fluid-heading-5)',
        'heading-4': 'var(--telekom-text-style-fluid-heading-4)',
        'heading-3': 'var(--telekom-text-style-fluid-heading-3)',
        'heading-2': 'var(--telekom-text-style-fluid-heading-2)',
        'heading-1': 'var(--telekom-text-style-fluid-heading-1)',
        'title-2': 'var(--telekom-text-style-fluid-title-2)',
        'title-1': 'var(--telekom-text-style-fluid-title-1)',
      },
      mobile: {
        badge: 'var(--telekom-text-style-mobile-badge)',
        small: 'var(--telekom-text-style-mobile-small)',
        'small-bold': 'var(--telekom-text-style-mobile-small-bold)',
        caption: 'var(--telekom-text-style-mobile-caption)',
        'caption-bold': 'var(--telekom-text-style-mobile-caption-bold)',
        body: 'var(--telekom-text-style-mobile-body)',
        'body-bold': 'var(--telekom-text-style-mobile-body-bold)',
        ui: 'var(--telekom-text-style-mobile-ui)',
        'ui-bold': 'var(--telekom-text-style-mobile-ui-bold)',
        'lead-text': 'var(--telekom-text-style-mobile-lead-text)',
        'heading-6': 'var(--telekom-text-style-mobile-heading-6)',
        'heading-5': 'var(--telekom-text-style-mobile-heading-5)',
        'heading-4': 'var(--telekom-text-style-mobile-heading-4)',
        'heading-3': 'var(--telekom-text-style-mobile-heading-3)',
        'heading-2': 'var(--telekom-text-style-mobile-heading-2)',
        'heading-1': 'var(--telekom-text-style-mobile-heading-1)',
        'title-2': 'var(--telekom-text-style-mobile-title-2)',
        'title-1': 'var(--telekom-text-style-mobile-title-1)',
      },
    ...
    fontSize: {
      fluid: {
        badge: 'var(--telekom-typography-font-size-fluid-badge)',
        small: 'var(--telekom-typography-font-size-fluid-small)',
        caption: 'var(--telekom-typography-font-size-fluid-caption)',
        body: 'var(--telekom-typography-font-size-fluid-body)',
        callout: 'var(--telekom-typography-font-size-fluid-callout)',
        'headline-3': 'var(--telekom-typography-font-size-fluid-headline-3)',
        'headline-2': 'var(--telekom-typography-font-size-fluid-headline-2)',
        'headline-1': 'var(--telekom-typography-font-size-fluid-headline-1)',
        'title-3': 'var(--telekom-typography-font-size-fluid-title-3)',
        'title-2': 'var(--telekom-typography-font-size-fluid-title-2)',
        'title-1': 'var(--telekom-typography-font-size-fluid-title-1)',
      },
      mobile: {
        badge: 'var(--telekom-typography-font-size-mobile-badge)',
        small: 'var(--telekom-typography-font-size-mobile-small)',
        caption: 'var(--telekom-typography-font-size-mobile-caption)',
        body: 'var(--telekom-typography-font-size-mobile-body)',
        callout: 'var(--telekom-typography-font-size-mobile-callout)',
        'headline-3': 'var(--telekom-typography-font-size-mobile-headline-3)',
        'headline-2': 'var(--telekom-typography-font-size-mobile-headline-2)',
        'headline-1': 'var(--telekom-typography-font-size-mobile-headline-1)',
        'title-3': 'var(--telekom-typography-font-size-mobile-title-3)',
        'title-2': 'var(--telekom-typography-font-size-mobile-title-2)',
        'title-1': 'var(--telekom-typography-font-size-mobile-title-1)',
      },
  ...
  plugins: [
     ...
     */
    plugin(function ({ matchUtilities, theme }) {
      console.log(flattenShadows(theme('shadow')))
      matchUtilities(
        {
          shadow: (value) => ({
            boxShadow: value,
